...
public class MenuActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView userID = findViewById(R.id.textView);
...
//            }
    ...
    private void finishRoute(){
        ...
        EndedRoute ruta = new EndedRoute(FirebaseInstanceId.getInstance().getToken(), "prueba");
        DatabaseReference mDatabase;
        mDatabase = FirebaseDatabase.getInstance().getReference("users/"+ FirebaseAuth.getInstance().getUid() + "/rutas");
        mDatabase.push().setValue(ruta);
    }
    ...
    private void getPreviousRoutes () {
        ...
        if (rutas != null) {
            // Puede ser que no haya rutas previas guardadas
